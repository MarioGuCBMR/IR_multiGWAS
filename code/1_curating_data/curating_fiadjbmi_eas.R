...
fiadjbmi <- fread("raw_data/summary_statistics/GCST90002237_buildGRCh37.tsv.gz") #East Asian checked: https://www.ebi.ac.uk/gwas/studies/GCST90002237
...
#2. Check the dateasame to see anything suspicious.
...
#1. Always order the dateasame with the variant ID. You might find interesting things.
...
#################################################################
#We are gonna separate the dateasames to: with NA and without NA#
#################################################################
...
fwrite(fiadjbmi_end, "output/1_curated_gwas/fiadjbmi_curated_eas.txt")
