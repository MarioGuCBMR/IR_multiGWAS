...
tg <- fread("raw_data/summary_statistics/logTG_INV_HIS_1KGP3_ALL.meta.singlevar.results.gz")
...
summary(tg$N) #no NAs. Min = 775, Max = 49,582 Works for me.
...
fwrite(tg_end, "output/1_curated_gwas/tg_curated_his.txt")
