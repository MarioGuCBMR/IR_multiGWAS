...
tg <- fread("raw_data/summary_statistics/logTG_INV_SAS_HRC_1KGP3_others_ALL.meta.singlevar.results.gz")
...
summary(tg$N) #no NAs. Min = 1391, Max = 40,846 Works for me.
...
fwrite(tg_end, "output/1_curated_gwas/tg_curated_sas.txt")
