...
tg_hdl_ratio <- fread("raw_data/GCST90295951.tsv")
...
tg_hdl_ratio$p_value <- 10^-(tg_hdl_ratio$neg_log_10_p_value) #checked and they work perfectly!!!!
...
fwrite(tg_hdl_ratio_end, "output/1_curated_data/tg_hdl_ratio_female_curated.txt")
