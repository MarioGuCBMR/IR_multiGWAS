...
fiadjbmi <- fread("raw_data/summary_statistics/GCST90002236_buildGRCh37.tsv.gz") #african american checked: https://www.ebi.ac.uk/gwas/studies/GCST90002236
...
fwrite(fiadjbmi_end, "output/1_curated_gwas/fiadjbmi_curated_afr.txt")
