...
hdl <- fread("raw_data/summary_statistics/HDL_INV_SAS_HRC_1KGP3_others_ALL.meta.singlevar.results.gz")
...
summary(hdl$N) #no NAs. Min = 1302, Max = 40,173 Works for me.
...
fwrite(hdl_end, "output/1_curated_gwas/hdl_curated_sas.txt")
