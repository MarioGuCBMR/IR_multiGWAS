...
hdl <- fread("raw_data/summary_statistics/HDL_INV_HIS_1KGP3_ALL.meta.singlevar.results.gz")
...
summary(hdl$N) #no NAs. Min = 1018, Max = 47.277 Works for me.
...
fwrite(hdl_end, "output/1_curated_gwas/hdl_curated_his.txt")
