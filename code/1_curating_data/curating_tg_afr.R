...
tg <- fread("raw_data/summary_statistics/logTG_INV_AFR_HRC_1KGP3_others_ALL.meta.singlevar.results.gz")
...
summary(tg$N) #no NAs. Min = 1288, Max = . Works for me.
...
fwrite(tg_end, "output/1_curated_gwas/tg_curated_afr.txt")
