...
fiadjbmi <- fread("raw_data/summary_statistics/GCST90002240_buildGRCh37.tsv.gz") #sast Asian checked: https://www.ebi.ac.uk/gwas/studies/GCST90002240
...
fwrite(fiadjbmi_end, "output/1_curated_gwas/fiadjbmi_curated_sas.txt")
