...
hdl <- fread("raw_data/summary_statistics/HDL_INV_EAS_1KGP3_ALL.meta.singlevar.results.gz")
...
summary(hdl$N) #no NAs. Min = 933, Max = 119.298. Works for me.
...
fwrite(hdl_end, "output/1_curated_gwas/hdl_curated_eas.txt")
