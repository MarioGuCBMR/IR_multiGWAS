...
#This code performs MR  for all cis-pQTL instruments - hcadjbmi systematically.
...
outcome <- fread("../IR_GSEM_2023/output/1_curated_data/hcadjbmi_giant_curated.txt")
...
for(protein_ in prot_list){
  ...
  if(length(mr_df$SNP) < 3){
    ...
    dir.create("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi")
    dir.create(paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_, sep = ""))
    
    #save data
    
    saveRDS(mr_steiger_df, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/instruments_after_steiger_df.RDS", sep = ""))
    ...
    saveRDS(mr_res, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/mr_res_before_outlier_extraction.RDS", sep = ""))
  ...
  tiff(filename = paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/plots_before_outlier_extraction.tiff", sep = ""), height=5000, width=5000, res=300)
  mr_plots(mr_steiger_df)
  dev.off()
  
  saveRDS(mr_res, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/mr_res_before_outlier_extraction.RDS", sep = ""))
  saveRDS(rucker, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/sensitivity_test_before_outlier_extraction.RDS", sep = ""))
  saveRDS(strict_het, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/strict_het_test_before_outlier_extraction.RDS", sep = ""))
  ...
  if(length(mr_post$SNP) < 3){ #run WALD or IVW only if less than 3 SNPs
    ...
    saveRDS(mr_post, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/instruments_after_outlier_removal_df.RDS", sep = ""))
    ...
    saveRDS(mr_res, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/mr_res_after_outlier_extraction.RDS", sep = ""))
  ...
  tiff(filename = paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/plots_after_outlier_extraction.tiff", sep = ""), height=5000, width=5000, res=300)
  mr_plots(mr_post)
  dev.off()
  
  saveRDS(mr_res, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/mr_res_after_outlier_extraction.RDS", sep = ""))
  saveRDS(rucker, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/sensitivity_test_after_outlier_extraction.RDS", sep = ""))
  saveRDS(strict_het, paste("output/9_pqtl_results/2_mr/1_mr_res/hcadjbmi/", protein_ , "/strict_het_test_after_outlier_extraction.RDS", sep = ""))
