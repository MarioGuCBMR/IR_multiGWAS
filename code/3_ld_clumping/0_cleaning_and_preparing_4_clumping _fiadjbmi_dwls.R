...
fiadjbmi_hdl_tg <- fread("output/2_mv_gwas/fiadjbmi_hdl_tg_dwls.txt")
...
fiadjbmi_hdl_tg_het <- fiadjbmi_hdl_tg_clean[which(as.numeric(fiadjbmi_hdl_tg_clean$Q_pval) < 5e-08)] #1470
...
fwrite(fiadjbmi_hdl_tg_common_clean, "output/2_mv_gwas/fiadjbmi_hdl_tg_common_dwls_curated.txt")
fwrite(fiadjbmi_hdl_tg_het_clean, "output/2_mv_gwas/fiadjbmi_hdl_tg_het_dwls_curated.txt")

########################################
#Now we set up the data for ld-clumping#
########################################

fiadjbmi_hdl_tg_common_4_clumping <- fiadjbmi_hdl_tg_common_clean[which(as.numeric(fiadjbmi_hdl_tg_common_clean$p_value) < 1e-06),] #6655
fiadjbmi_hdl_tg_het_4_clumping <- fiadjbmi_hdl_tg_het_clean[which(as.numeric(fiadjbmi_hdl_tg_het_clean$p_value) < 1e-06),] #36

fiadjbmi_hdl_tg_common_4_clumping <- formatting_data_4_clumping(fiadjbmi_hdl_tg_common_4_clumping)
fiadjbmi_hdl_tg_het_4_clumping <- formatting_data_4_clumping(fiadjbmi_hdl_tg_het_4_clumping)

#####################
#Let's save the data#
#####################

dir.create("output/3_ld_clumping/")
dir.create("output/3_ld_clumping/1_data_4_clumping")

fwrite(fiadjbmi_hdl_tg_common_4_clumping, "output/3_ld_clumping/1_data_4_clumping/fiadjbmi_hdl_tg_common_dwls_4_clumping.txt", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t")
fwrite(fiadjbmi_hdl_tg_het_4_clumping, "output/3_ld_clumping/1_data_4_clumping/fiadjbmi_hdl_tg_het_dwls_4_clumping.txt", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t")
