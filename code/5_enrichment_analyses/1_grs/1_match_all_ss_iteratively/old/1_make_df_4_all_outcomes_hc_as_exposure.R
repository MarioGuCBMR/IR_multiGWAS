...
output_path <- "output/5_comparing_fiadjbmi_fi/4_mr/all_variants/1_expo_outcome_df_hc/"
...
data_df <- hc_ss[which(hc_ss$chr_pos%in%all_variants$chr_pos),]
...
recursively_matching_data(exp_df = ir_df, list_of_phenos_ =list_of_phenos, trait_names_ = trait_names, output_path <- output_path, exposure = "hc_ir_variants_")
