...
output_path <- "output/5_comparing_fiadjbmi_fi/4_mr/all_variants/1_expo_outcome_df_tg_hdl_ratio/"
...
data_df <- tg_hdl_ratio[which(tg_hdl_ratio$chr_pos%in%all_variants$chr_pos),]
...
recursively_matching_data(exp_df = data_df, list_of_phenos_ =list_of_phenos, trait_names_ = trait_names, output_path <- output_path, exposure = "tg_hdl_all_variants_")
...
recursively_matching_data(exp_df = ir_df, list_of_phenos_ =list_of_phenos, trait_names_ = trait_names, output_path <- output_path, exposure = "tg_hdl_ir_variants_")
...
recursively_matching_data(exp_df = non_ir_df, list_of_phenos_ =list_of_phenos, trait_names_ = trait_names, output_path <- output_path, exposure = "tg_hdl_non_ir_variants_")
...
recursively_matching_data(exp_df = novel_ir_df, list_of_phenos_ =list_of_phenos, trait_names_ = trait_names, output_path <- output_path, exposure = "tg_hdl_novel_ir_variants_")
...
recursively_matching_data(exp_df = reported_ir_df, list_of_phenos_ =list_of_phenos, trait_names_ = trait_names, output_path <- output_path, exposure = "tg_hdl_reported_ir_variants_")
