...
dir.create("output/5_enrichment_analyses/4_homer/input/282_sgbs_day_0/")
dir.create("output/5_enrichment_analyses/4_homer/output/282_sgbs_day_0/")

fwrite(unique(IR_peaks), "output/5_enrichment_analyses/4_homer/input/282_sgbs_day_0/IR_peaks.txt", sep = "\t", col.names = F)
...
fwrite(unique(non_IR_peaks), "output/5_enrichment_analyses/4_homer/input/282_sgbs_day_0/non_IR_peaks.txt", sep = "\t", col.names = F)
