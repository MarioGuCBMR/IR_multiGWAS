...
dir.create("output/5_enrichment_analyses/4_homer/input/63_sgbs_day_4")
dir.create("output/5_enrichment_analyses/4_homer/output/63_sgbs_day_4")

fwrite(unique(IR_peaks), "output/5_enrichment_analyses/4_homer/input/63_sgbs_day_4/IR_peaks.txt", sep = "\t", col.names = F)
...
fwrite(unique(non_IR_peaks), "output/5_enrichment_analyses/4_homer/input/63_sgbs_day_4/non_IR_peaks.txt", sep = "\t", col.names = F)
