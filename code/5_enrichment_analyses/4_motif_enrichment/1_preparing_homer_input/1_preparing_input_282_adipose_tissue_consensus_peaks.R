...
peaks <- fread('raw_data/atac_seq_data/GSE178794_adiposeTissue_consensusPeaks-from11samples_unionPeaksInAtLeast3samples.bed.gz')
...
dir.create("output/5_enrichment_analyses/4_homer/input/282_adipose_consensus")
dir.create("output/5_enrichment_analyses/4_homer/output/282_adipose_consensus")

fwrite(unique(IR_peaks), "output/5_enrichment_analyses/4_homer/input/282_adipose_consensus/IR_peaks.txt", sep = "\t", col.names = F)
...
non_IR_peaks <-  peaks
colnames(non_IR_peaks) <- c("chr_peak","start_peak","end_peak","peakID", "GC")
...
fwrite(unique(non_IR_peaks), "output/5_enrichment_analyses/4_homer/input/282_adipose_consensus/non_IR_peaks.txt", sep = "\t", col.names = F)
