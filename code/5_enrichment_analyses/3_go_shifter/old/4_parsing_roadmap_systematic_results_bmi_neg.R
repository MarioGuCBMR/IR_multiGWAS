...
parse_and_update <- function(list_file_, tissue_df){
  ...
  for(file_ in list_file_){
    ...
    e_tmp <- data.table::fread(paste("output/5_enrichment_analyses/3_go_shifter/output/bmi_neg/roadmap_systematic/", file_, sep = ""))
...
list_of_files <- list.files("output/5_enrichment_analyses/3_go_shifter/output/bmi_neg/roadmap_systematic/")
...
adipose <- fread("output/5_enrichment_analyses/3_go_shifter/output/bmi_neg/metsim/adipose.nperm10000.enrich")
sbgs_day0 <- fread("output/5_enrichment_analyses/3_go_shifter/output/bmi_neg/metsim/sgbs_day0.nperm10000.enrich")
sbgs_day4 <- fread("output/5_enrichment_analyses/3_go_shifter/output/bmi_neg/metsim/sgbs_day4.nperm10000.enrich")
sbgs_day14 <- fread("output/5_enrichment_analyses/3_go_shifter/output/bmi_neg/metsim/sgbs_day14.nperm10000.enrich")
...
fwrite(roadmap_update, "output/5_enrichment_analyses/3_go_shifter/output/enrichment_bmi_neg_df.txt")
...
tiff("output/5_enrichment_analyses/3_go_shifter/output/enrichment_plot_bmi_neg.tiff", width = 4000, height = 3500, res=300)
plot
dev.off()
