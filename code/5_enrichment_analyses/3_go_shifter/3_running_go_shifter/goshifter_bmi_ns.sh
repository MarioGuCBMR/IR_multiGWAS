...
annotation=/maps/projects/kilpelainen-AUDIT/people/zlc436/IR_GSEM_2025/output/3_go_shifter/curated_atac_seq
output=/maps/projects/kilpelainen-AUDIT/people/zlc436/IR_GSEM_2025/output/3_go_shifter/output/bmi_ns
...
$code/goshifter.py --snpmap $input/input_bmi_ns.txt --annotation $annotation/peaks_adipose_tissue.bed.gz --permute 10000 --proxies $input/ld_bmi_ns.txt --out $output/metsim/adipose #P=0.0113
$code/goshifter.py --snpmap $input/input_bmi_ns.txt --annotation $annotation/peaks_sgbs_day0.bed.gz --permute 10000 --proxies $input/ld_bmi_ns.txt --out $output/metsim/sgbs_day0 #P=0.0379
$code/goshifter.py --snpmap $input/input_bmi_ns.txt --annotation $annotation/peaks_sgbs_day4.bed.gz --permute 10000 --proxies $input/ld_bmi_ns.txt --out $output/metsim/sgbs_day4 #P=0.0246
$code/goshifter.py --snpmap $input/input_bmi_ns.txt --annotation $annotation/peaks_sgbs_day14.bed.gz --permute 10000 --proxies $input/ld_bmi_ns.txt --out $output/metsim/sgbs_day14 #P=0.0104
...
for file in "${files[@]}"; do
   ...
   $code/goshifter.py --snpmap $input/input_bmi_ns.txt --annotation $file.bed.gz --permute 10000 --proxies $input/ld_bmi_ns.txt --out $output/roadmap_systematic/$filename
done
