...
$code/goshifter.py --snpmap $input/input.txt --annotation $annotation/peaks_adipose_tissue.bed.gz --permute 10000 --proxies $input/ld.txt --out $output/metsim/adipose #P=0.0
$code/goshifter.py --snpmap $input/input.txt --annotation $annotation/peaks_sgbs_day0.bed.gz --permute 10000 --proxies $input/ld.txt --out $output/metsim/sgbs_day0 #P=0.068
$code/goshifter.py --snpmap $input/input.txt --annotation $annotation/peaks_sgbs_day4.bed.gz --permute 10000 --proxies $input/ld.txt --out $output/metsim/sgbs_day4 #P=0.0001
$code/goshifter.py --snpmap $input/input.txt --annotation $annotation/peaks_sgbs_day14.bed.gz --permute 10000 --proxies $input/ld.txt --out $output/metsim/sgbs_day14 #P=0.0
...
for file in "${files[@]}"; do
   ...
   $code/goshifter.py --snpmap $input/input.txt --annotation $file.bed.gz --permute 10000 --proxies $input/ld.txt --out $output/roadmap_systematic/$filename
done
