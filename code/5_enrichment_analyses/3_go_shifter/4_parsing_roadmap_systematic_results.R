...
parse_and_update <- function(list_file_, tissue_df){
  ...
  for(file_ in list_file_){
    ...
    e_tmp <- data.table::fread(paste("output/5_enrichment_analyses/3_go_shifter/output/roadmap_systematic/", file_, sep = ""))
...
list_of_files <- list.files("output/5_enrichment_analyses/3_go_shifter/output/roadmap_systematic/")
...
adipose <- fread("output/5_enrichment_analyses/3_go_shifter/output/metsim/adipose.nperm10000.enrich")
sbgs_day0 <- fread("output/5_enrichment_analyses/3_go_shifter/output/metsim/sgbs_day0.nperm10000.enrich")
sbgs_day4 <- fread("output/5_enrichment_analyses/3_go_shifter/output/metsim/sgbs_day4.nperm10000.enrich")
sbgs_day14 <- fread("output/5_enrichment_analyses/3_go_shifter/output/metsim/sgbs_day14.nperm10000.enrich")
...
fwrite(roadmap_update, "output/5_enrichment_analyses/3_go_shifter/output/enrichment_df.txt", sep = "\t")
...
ggsave(
  filename = "N:/SUN-CBMR-Kilpelainen-Group/Mario_Tools/IR_GSEM_2025/manuscript/figures/go_shifter_enrichment_plot.svg",
  plot = plot,
  width = 12,
  height = 10,
