...
path_2_files <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/insulin_resistance_variants_common_info/"

setwd(path_2_files)

fi_curated <- fread("output/1_curated_data/fiadjbmi_curated.txt")
hdl_curated <- fread("output/1_curated_data/hdl_curated.txt")
tg_curated <- fread("output/1_curated_data/tg_curated.txt")
...
colnames(fi_common_pos) <- c("variant", "chr","pos", "a1", "a0", "effect_allele_frequency", "beta", "standard_error", "p_value", "sample_size", "ID")
...
fi_hdl_df_clean <- fi_hdl_df %>%
  select("variant.ss", "ID.ss",  "chr", "pos", "a0", "a1", "effect_allele_frequency.ss",
...
fwrite(final_sumstats_df, "output/2_variant_discovery/1_triangulation/4_data_4_cpassoc_and_curated_results/merged_fiadjbmi_hdl_tg_sumstats_4_cpassoc.txt")
...
fwrite(sumstats_4_pruning, "output/2_variant_discovery/1_triangulation/4_data_4_cpassoc_and_curated_results/merged_fiadjbmi_hdl_tg_sumstats_w_maxZ_1.96.txt")
...
sumstats_pruned <- ieugwasr::ld_clump_local(sumstats_4_pruning, bfile = "C:/Users/zlc436/Downloads/1kg.v3/1kg.v3/EUR", plink_bin ="C:/Users/zlc436/Documents/R/R-4.1.3/library/plinkbinr/bin/plink_Windows.exe", clump_kb = 500, clump_r2 = 0.2, clump_p = 1) 
...
fwrite(sumstats_pruned, "output/2_variant_discovery/1_triangulation/4_data_4_cpassoc_and_curated_results/pruned_fiadjbmi_hdl_tg_sumstats_w_maxZ_1.96.txt")
...
saveRDS(corr_matrix, "output/2_variant_discovery/1_triangulation/4_data_4_cpassoc_and_curated_results/correlation_matrix_between_traits.RDS")
