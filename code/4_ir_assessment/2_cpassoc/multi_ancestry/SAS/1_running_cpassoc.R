...
final_sumstats <- fread("output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/SAS/merged_fiadjbmi_hdl_tg_sumstats_4_cpassoc.txt")
corMatrix <- readRDS("output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/SAS/correlation_matrix_between_traits.RDS")
...
fwrite(triangulated_match, "output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/SAS/282_ir_fiadjbmi_hdl_tg_dwls_snps_w_cpassoc.txt")
