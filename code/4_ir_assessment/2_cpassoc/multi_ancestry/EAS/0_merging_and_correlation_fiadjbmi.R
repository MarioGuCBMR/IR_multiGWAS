...
fi_curated <- fread("output/1_curated_gwas/fiadjbmi_curated_eas.txt")
hdl_curated <- fread("output/1_curated_gwas/hdl_curated_eas.txt")
tg_curated <- fread("output/1_curated_gwas/tg_curated_eas.txt")
...
dir.create("output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/EAS")

fwrite(final_sumstats_df, "output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/EAS/merged_fiadjbmi_hdl_tg_sumstats_4_cpassoc.txt")
...
fwrite(sumstats_4_pruning, "output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/EAS/merged_fiadjbmi_hdl_tg_sumstats_w_maxZ_1.96.txt")
...
sumstats_pruned <- ieugwasr::ld_clump_local(sumstats_4_pruning, bfile = "C:/Users/zlc436/Desktop/1kg.v3/EAS", plink_bin ="C:/Users/zlc436/Documents/R/R-4.1.3/library/plinkbinr/bin/plink_Windows.exe", clump_kb = 500, clump_r2 = 0.2, clump_p = 1) 
...
fwrite(sumstats_pruned, "output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/EAS/pruned_fiadjbmi_hdl_tg_sumstats_w_maxZ_1.96.txt") #800k
...
saveRDS(corr_matrix, "output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/EAS/correlation_matrix_between_traits.RDS")
