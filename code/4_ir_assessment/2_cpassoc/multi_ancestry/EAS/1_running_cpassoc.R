...
final_sumstats <- fread("output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/EAS/merged_fiadjbmi_hdl_tg_sumstats_4_cpassoc.txt")
corMatrix <- readRDS("output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/EAS/correlation_matrix_between_traits.RDS")
...
length(which(Sumstats_ordered$chr_pos == triangulated_match$chr_pos)) #304/352
...
fwrite(triangulated_match, "output/4_ir_loci_discovery/1_cpassoc/multi_ancestry/EAS/282_ir_fiadjbmi_hdl_tg_dwls_snps_w_cpassoc.txt")
